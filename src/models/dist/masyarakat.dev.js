...
module.exports = function (sequelize, DataTypes) {
  ...
  /*#__PURE__*/
  function (_Model) {
    _inherits(masyarakat, _Model);

    function masyarakat() {
      _classCallCheck(this, masyarakat);

      return _possibleConstructorReturn(this, _getPrototypeOf(masyarakat).apply(this, arguments));
    }

    _createClass(masyarakat, null, [{
      key: "associate",
