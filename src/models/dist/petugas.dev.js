...
module.exports = function (sequelize, DataTypes) {
  ...
  /*#__PURE__*/
  function (_Model) {
    _inherits(petugas, _Model);

    function petugas() {
      _classCallCheck(this, petugas);

      return _possibleConstructorReturn(this, _getPrototypeOf(petugas).apply(this, arguments));
    }

    _createClass(petugas, null, [{
      key: "associate",
